    ...
    return(
        <div className="flex flex-row md:max-2xl:gap-x-3.5 gap-x-1 my-3">
            ...
            <div className="relative md:max-2xl:gap-x-3.5">
                ...
                {props.hostingLink != "" ? <Link href={props.gitHubLink} className="group absolute left-20 align-middle justify-self-end text-dusty hover:text-mudbrick font-semibold md:max-2xl:text-sm text-sm pt-2 flex-none" target="_blank">
                    Visit
                    <span className="pl-0.5 group-hover:pl-1.5 duration-500">›</span>
                </Link>:<></>}
            </div>
