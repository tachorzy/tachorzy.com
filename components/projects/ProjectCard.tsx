...
const ProjectCard = (props: project) => {
    ...
    return(
        <div className="mt-0.5 w-[17rem] lg:w-80 lg:h-[19.25rem] bg-metal rounded-md shadow-2xl hover:scale-105 duration-500">
            ...
            <div className="justify-center content-center pt-4 px-6 pb-1">
                <p className={JakartaExtraBold.className + " text-dusty text-2xl"}>{props.name}</p>
                <p className={JakartaSemibold.className + " text-mudbrick text-lg"}>{props.description}</p>
