...
const ProjectCard = (props: project) => {
    ...
    return(
        <div className="snap-start w-[17rem] lg:w-80 lg:h-[19.25rem] lg:scale-[80%] lg:hover:scale-[85%] xl:scale-100 bg-metal rounded-md shadow-2xl hover:scale-105 xl:hover:scale-105 duration-500">
