    ...
    return(
        <div className="project-tech-tray flex flex-row md:gap-x-3.5 gap-x-2.5 my-5 mb-3">
            ...
            <div className={JakartaBold.className + " relative md:gap-x-3.5"}>
                <Link href={props.gitHubLink} className="group absolute align-middle justify-self-end text-dusty hover:text-mudbrick font-semibold md:text-sm text-xs pt-2 flex-none px-1.5" target="_blank">
                    GitHub
                    <span className="pl-0.5 group-hover:pl-1.5 duration-500">›</span>
                </Link>
                {props.hostLink &&
                    <Link href={props.hostLink} className="group absolute left-20 align-middle justify-self-end text-dusty hover:text-mudbrick font-semibold md:text-sm text-xs pt-2 flex-none" target="_blank">
                        Visit
                        <span className="pl-0.5 group-hover:pl-1.5 duration-500">›</span>
                    </Link>
                }
