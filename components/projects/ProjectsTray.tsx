...
const ProjectsTray = () => {
    return(
        <div className="relative z-40">
            <div className="absolute inset-0 z-20 w-1/4 ml-[85%] bg-[linear-gradient(to_left,#1c2324_25%,transparent)]"></div> 
            <div className="grid md:grid-flow-col lg:gap-y-6 lg:gap-x-0 xl:gap-y-12 md:gap-x-12 mb-14 2xl:mb-9 md:overflow-x-scroll md:overflow-y-hidden overflow-y-scroll overflow-x-hidden snap-x scroll-smooth pb-10"> 
