...
const CountryCard = (props: country) => {
    return(
        <div className={ManropeRegular.className + " mt-0.5 w-[17rem] h-80 md:max-2xl:w-80 md:max-2xl:h-[19.25rem] bg-metal rounded-md shadow-2xl hover:scale-105 duration-500"}>
