...
const Experience = (props: ExperienceData) => {
    ...
    return(
        <div className={JakartaRegular.className + " text-sandstone 2xl:text-xl lg:text-lg md:text-base text-xs w-full lg:min-h-32 bg-metal hover:bg-[#1C2B2D] border-l-4 duration-500 border-opacity-75 border-sandstone border-[#1C2B2D]"}>
