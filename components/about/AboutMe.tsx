...
const AboutMe = () => {
    return(
        <div className={ManropeMedium.className + " text-sandstone lg:text-xl md:text-lg text-xs font-medium pt-1.5 flex flex-col gap-y-4 lg:mt-2 mt-1.5 leading-loose md:w-3/5 w-4/5"}>
