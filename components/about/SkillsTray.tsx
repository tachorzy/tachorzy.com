                    ...
                    return(
                        <div key={index} className="flex flex-col group items-center">
                            <Link href={documentation} target="_blank">
                                <Image src ={`/icons/skills/${programmingLanguage}.svg`} width="0" height="0" alt="language/library/framework icon" className="select-none md:w-9 md:h-9 w-6 h-6 hover:scale-105"></Image>
                            </Link>
