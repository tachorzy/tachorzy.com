...
const sections: Map<string, Section> = new Map([
    ...
    ["travel", {margin: "mb-72 lg:mt-[40rem]", sectionTitle: "Travel", sectionTitleMargin: "mb-7", coreComponent: <CountryCardTray/>, pageNumber: "٣", nextButtonMargins: "xl:mt-48 2xl:mt-0" ,nextPageReference: "#contact"}],
