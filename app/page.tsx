...
const sections: Map<string, Section> = new Map([
    ...
    ["about", { sectionTitle: "About Me", coreComponent: <AboutMe/>, trayComponent: <SkillsTray/>, pageNumber: "١", nextPageReference: "#projects", nextButtonMargins: "mt-2.5 xl:mt-[20%] 2xl:mt-[11.5%] 2xl:mb-36"}],
    ...
    ["travel", {margin: "mb-72 mt-[40rem]", sectionTitle: "Travel", sectionTitleMargin: "mb-7", coreComponent: <CountryCardTray/>, pageNumber: "٣", nextButtonMargins: "xl:mt-48 2xl:mt-0" ,nextPageReference: "#contact"}],
