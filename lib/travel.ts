...
export const PLACES_TRAVELLED: Map<string, { coverImageURL: string, isoCode: string, destinations: string[]}> = new Map([
        ["El Salvador", { coverImageURL: "/travel/ElSalvador/country_cover.jpg", isoCode: "SV", destinations: ["San Salvador", "Santa Ana", "Suchitoto"]}],
        ...
        ["Palestine",{ coverImageURL: "/travel/Palestine/country_cover.jpg", isoCode: "PS", destinations: ["Jerusalem (Old City)", "Bethlehem", "Battir", "Dheisha", "Ramallah", "Nablus"] }],
