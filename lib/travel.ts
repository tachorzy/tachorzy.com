...
export const PLACES_TRAVELLED: Map<string, { coverImageURL: string, yearVisited: string, isoCode: string, destinations: string[]}> = new Map([
        ...
        ["Jerusalem & the West Bank",{ coverImageURL: "/travel/Palestine/country_cover.jpg", yearVisited: "2023", isoCode: "PS", destinations: ["Jerusalem (Old City)", "Bethlehem", "Battir", "Dheisha", "Ramallah", "Nablus"] }],
        ["Jordan", { coverImageURL: "/travel/Jordan/country_cover.jpg", isoCode: "JO", yearVisited: "2023", destinations: ["Amman", "Wadi Musa"] }],
        ["Lebanon", { coverImageURL: "/travel/Lebanon/country_cover.jpg", isoCode: "LB", yearVisited: "2023", destinations: ["Beirut", "Chouf", "Aannaya", "Batroun", "Byblos", "Tripoli", "Bcharre"] }],
        ["Mexico", { coverImageURL: "/travel/Mexico/country_cover.jpg", isoCode: "MX", yearVisited: "2022", destinations: ["CDMX", "Taxco"] }],
        ["Türkiye", { coverImageURL: "/travel/Turkey/country_cover.jpg", isoCode: "TR", yearVisited: "2022", destinations: ["İstanbul", "Urfa", "Diyarbakır", "Mardin"] }],
